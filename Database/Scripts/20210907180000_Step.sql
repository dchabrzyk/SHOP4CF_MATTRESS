...
GRANT DELETE, INSERT, SELECT, UPDATE ON TABLE public."Steps" TO mamma_user;
...
--rollback GRANT DELETE, INSERT, SELECT, UPDATE ON TABLE public."DefaultTaskPerformances" TO mamma_user;
