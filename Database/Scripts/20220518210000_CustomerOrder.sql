...
GRANT DELETE, INSERT, SELECT, UPDATE ON TABLE public."CustomerOrders" TO mamma_user;
...
GRANT DELETE, INSERT, SELECT, UPDATE ON TABLE public."CustomerOrderLines" TO mamma_user;
